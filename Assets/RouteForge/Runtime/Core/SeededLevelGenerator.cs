...
{
    /// <summary>
    /// Создает уровень из seed без зависимости от внешнего состояния.
    /// </summary>
    public sealed class SeededLevelGenerator
    {
        /// <summary>
        /// Генерирует уровень по seed и настройкам.
        /// </summary>
        /// <param name="seed">Seed генератора.</param>
        /// <param name="settings">Настройки создаваемого уровня.</param>
        /// <returns>Детерминированно созданный уровень.</returns>
